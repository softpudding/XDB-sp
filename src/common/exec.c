...
find_my_exec(const char *argv0, char *retpath)
{
	...
	//log_error(_("current working directory: %s"),
	//			cwd);
	...
	{
		//log_error(_("argv0 %s contains a separator, so PATH not used!"),
		//			argv0);
	...
	{
		//log_error(_("argv0 %s not contains a separator, so PATH used!"),
		//			argv0);
		char	   *startp = NULL,
				   *endp = NULL;
